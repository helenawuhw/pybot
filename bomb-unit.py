...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_shouldRespond_emptyString(self):
        self.assertEquals(False, bomb.shouldRespond(''))

    def test_shouldRespond_notRelevant(self):
        self.assertEquals(False, bomb.shouldRespond('obot is going to the moon'))
    ...
    def test_parsePhotoUrlFromJsonResponse(self):
        self.assertEquals(
          ...
          'http:\/\/farm9.staticflickr.com\/8120\/8792081739_9538871ce5_c.jpg',
